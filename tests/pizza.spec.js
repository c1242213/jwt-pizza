...
test('register and get franchises', async ({ page }) => {
    await page.route('*/**/api/auth', async (route) => {
      const registerReq = {"name": "carlee","email": "carlee@jwt.com","password": "1234"};
      const registerRes = {"user": {"name": "carlee","email": "carlee@jwt.com", "roles": [{"role": "diner"}],"id": 552},"token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiY3JlZWQiLCJlbWFpbCI6ImNyZWVkQGp3dC5jb20iLCJyb2xlcyI6W3sicm9sZSI6ImRpbmVyIn1dLCJpZCI6NTUyLCJpYXQiOjE3MzkyNDM5OTB9.eCBXxeWHuzO783VzXANxM69i3B-hNv-dE_sRoGSk0bs"};
      expect(route.request().method()).toBe('POST');
    ...
    await page.getByRole('textbox', { name: 'Full name' }).fill('carlee');
    await page.getByRole('textbox', { name: 'Email address' }).click();
    await page.getByRole('textbox', { name: 'Email address' }).fill('carlee@jwt.com');
